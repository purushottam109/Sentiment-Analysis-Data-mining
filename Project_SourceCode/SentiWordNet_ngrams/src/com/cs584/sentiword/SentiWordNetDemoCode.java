...
public class SentiWordNetDemoCode {
	...
	public static void main(String [] args) throws IOException {
		...
		String path = bundle.getString("sentiword_dictionary_path");
		SentiWordNetDemoCode sentiwordnet = new SentiWordNetDemoCode(path);
		
		System.out.println("beautiful#a "+sentiwordnet.extract("beautiful", "a"));
		System.out.println("ugly#a "+sentiwordnet.extract("ugly", "a"));
